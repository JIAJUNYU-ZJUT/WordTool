...
if __name__ == '__main__':
    ...
    dir_path = r"/Users/mac/Desktop/仓前车卡" #文件夹目录
    ...
    for root_path in root_paths:
        ...
        if os.path.isdir(absolute_root_path) and (not root_path.startswith('.')):
            excel_file_path = r"/Users/mac/Desktop/删减-项目进度跟踪表3.28.xlsx"
            sheet_name = "仓前"
            save_path = r"/Users/mac/Desktop/测试/" + root_path
            if not os.path.exists(save_path):
                os.mkdir(save_path)
            pic_path = r"/Users/mac/Desktop/900W车卡截图修改"
            single_dir_process(absolute_root_path,excel_file_path,sheet_name,absolute_root_path,pic_path)
